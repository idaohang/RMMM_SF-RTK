...
static void arc_ukf_measfunc(double *input_X,double *output_Y)  /* todo:this function have some problem and bugs,need to fix */
{
    ...
    if ((ndd=arc_ddres(_UKF_RTK_,_UKF_NAV_,dt,xp,NULL,_UKF_SAT_,_KF_Y_,_UKF_E_,
                       _UKF_AZEL_,_UKF_IU_,_UKF_IR_,_UKF_NR_,v,NULL,NULL,
                       _UKF_VFLAG_,_UKF_Y_,_UKF_DY_))<1) {
